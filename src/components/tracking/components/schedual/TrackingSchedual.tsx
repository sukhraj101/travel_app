                            ...
                            <div className="d-flex gap-3 tracking_schedual_circle_box">
                                ...
                                <div className="col-md-11 tracking_schedule_accor_right">
                                    <div className="accordion" id="scheduleAcc2">
                                        <div className="accordion-item border-0">
                                            <p className="fw-semibold m-0 tracking_schedual_track_heading">You'll get picked up</p>
                                            <h2 className="accordion-header tracking_schedule_acco_heading" id="panelsStayOpen-headingTwo">
                                                <button className="accordion-button collapsed p-0 tracking_schedual_accor_btn " type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-headingTwo">
                                                    See departure details
                                                </button>
                                            </h2>
