          ...
          <div className="col-lg-6">
            <div className="card ">
              ...
              <div className="comment-widgets scrollable">
                <div className="d-flex flex-row comment-row mt-0 custom-card">
                  <div className="p-2">
                    <img
                ...
                <div className="d-flex flex-row comment-row custom-card">
                  <div className="p-2">
                    <img
          ...
          <div className="card custom-card">
            ...
            <div className="card">
              ...
              <ul className="list-style-none">
                <li className="d-flex no-block card-body custom-card">
                ...
                <li className="d-flex no-block card-body custom-card border-top">
