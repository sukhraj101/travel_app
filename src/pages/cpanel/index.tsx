                      ...
                      <ul className="list-style-none assignedto">
                        ...
                        <li className="assignee">
                          <img
                            className="rounded-circle"
                            width={40}
                            src="./../../../public/admin/assets/images/users/2.jpg"
                            alt="user"
                            data-toggle="tooltip"
                            data-placement="top"
                            title=""
                        ...
                        <li className="assignee">
                          <img
                            className="rounded-circle"
                            width={40}
                            src="./../../../public/admin/assets/images/users/3.jpg"
                            alt="user"
                            data-toggle="tooltip"
                            data-placement="top"
                            title=""
                  ...
                  <ul className="chat-list">
                    <li className="chat-item">
                      <div className="chat-img">
                        <img src="./../../../public/admin/assets/images/users/1.jpg" alt="user" />
                      </div>
                    ...
                    <li className="chat-item">
                      <div className="chat-img">
                        <img src="./../../../public/admin/assets/images/users/2.jpg" alt="user" />
                      </div>
                      <div className="chat-content">
                    ...
                    <li className="chat-item">
                      <div className="chat-img">
                        <img src="./../../../public/admin/assets/images/users/3.jpg" alt="user" />
                      </div>
                      <div className="chat-content">
              ...
              <div className="tab-content tabcontent-border">
                <div className="tab-pane active" id="home" role="tabpanel">
                  <div className="p-2">
                    ...
                    <img
                      src="./../../../public/admin/assets/images/background/img4.jpg"
                      className="img-fluid"
                    />
                  </div>
                </div>
                <div className="tab-pane p-2" id="profile" role="tabpanel">
                  <div className="p-2">
                    <img
                      src="./../../../public/admin/assets/images/background/img4.jpg"
                      className="img-fluid"
                ...
                <div className="tab-pane p-2" id="messages" role="tabpanel">
                  <div className="p-2">
                    <p>
                      And is full of waffle to It has multiple paragraphs and is
                      full of waffle to pad out the comment. Usually, you just
